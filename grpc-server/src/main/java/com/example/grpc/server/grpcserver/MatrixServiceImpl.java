...
{
	@Override
	public void multiplyBlock(RequestMatrices request, StreamObserver<MatrixReply> reply)
	{
	...
	@Override
	public void addBlock(RequestMatrices request, StreamObserver<MatrixReply> reply)
	{
		System.out.println("Request received from client:\n" + request);
